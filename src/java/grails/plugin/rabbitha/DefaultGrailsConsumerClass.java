 ...
 * @since 0.1
 */
public class DefaultGrailsConsumerClass extends AbstractInjectableGrailsClass implements GrailsConsumerClass {

    public static final String CONSUMER = "Consumer";
    private Map triggers = new HashMap();


    public DefaultGrailsConsumerClass(Class clazz) {
